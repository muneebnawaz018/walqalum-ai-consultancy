    ...
    <section className="view" data-route="about">
      ...
      <section className="band"><div className="wrap">
        ...
        <div className="people stagger">
          ...
          <div className="person" style={{ display: "flex", flexDirection: "column", justifyContent: "center", background: "var(--ink)", color: "var(--white)", padding: "26px" }}><h4 className="display" style={{ color: "var(--white)", fontSize: "22px" }} data-en="40+ engineers, designers & strategists behind them." data-ar="+40 مهندسًا ومصمّمًا واستراتيجيًّا خلفهم.">40+ engineers, designers & strategists behind them.</h4><Link href="/contact" className="tlink" data-nav="contact" style={{ color: "var(--accent)", marginTop: "16px" }}><span className="u" data-en="Work with us" data-ar="اعمل معنا">Work with us</span></Link></div>
        </div>
      </div></section>
      <section className="band"><div className="wrap">
