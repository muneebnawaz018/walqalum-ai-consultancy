    ...
    <>
      ...
      <div className="proto" id="proto">
        ...
        <div className="proto-panel" id="protoPanel" hidden>
          ...
          <div className="proto-row"><span className="proto-lbl" data-en="Accent" data-ar="اللون">Accent</span><div className="dots"><button className="sw-dot" data-set="accent" data-val="persimmon" style={{ "--c": "#E5462B" } as CSSProperties} aria-pressed="true" aria-label="Persimmon" title="Persimmon"></button><button className="sw-dot" data-set="accent" data-val="cobalt" style={{ "--c": "#1E49E2" } as CSSProperties} aria-pressed="false" aria-label="Cobalt" title="Cobalt"></button><button className="sw-dot" data-set="accent" data-val="emerald" style={{ "--c": "#0E8F5E" } as CSSProperties} aria-pressed="false" aria-label="Emerald" title="Emerald"></button><button className="sw-dot" data-set="accent" data-val="magenta" style={{ "--c": "#C21E6B" } as CSSProperties} aria-pressed="false" aria-label="Magenta" title="Magenta"></button></div></div>
